...
batchCreateChunks
  ...
  => Corpus2 -- ^ "corpus" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Document2 -- ^ "document" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
batchEmbedContents
  ...
  => Model2 -- ^ "model" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
-- 
cancelOperation
  :: GenerateContentBatch -- ^ "generateContentBatch" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
createPermission
  ...
  => TunedModel2 -- ^ "tunedModel" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
-- 
deleteCachedContent
  :: Id -- ^ "id" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
deleteChunk
  :: Corpus2 -- ^ "corpus" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Document2 -- ^ "document" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Chunk2 -- ^ "chunk" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
-- 
deleteFile
  :: File2 -- ^ "file" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
deletePermission
  :: TunedModel2 -- ^ "tunedModel" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Permission2 -- ^ "permission" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
generateContentByDynamicId
  ...
  => DynamicId -- ^ "dynamicId" -  Part of `model`. Required. The name of the `Model` to use for generating the completion.  Format: `models/{model}`.
...
-- 
getGeneratedFile
  :: GeneratedFile2 -- ^ "generatedFile" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
getOperation
  :: TunedModel2 -- ^ "tunedModel" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Operation2 -- ^ "operation" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
...
updateChunk
  ...
  => Corpus2 -- ^ "corpus" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Document2 -- ^ "document" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Chunk2 -- ^ "chunk2" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> UpdateMask -- ^ "updateMask" -  Required. The list of fields to update. Currently, this only supports updating `custom_metadata` and `data`.
...
updateCorpus
  ...
  => Corpus2 -- ^ "corpus2" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> UpdateMask -- ^ "updateMask" -  Required. The list of fields to update. Currently, this only supports updating `display_name`.
...
updateDocument
  ...
  => Corpus2 -- ^ "corpus" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Document2 -- ^ "document2" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> UpdateMask -- ^ "updateMask" -  Required. The list of fields to update. Currently, this only supports updating `display_name` and `custom_metadata`.
...
updatePermission
  ...
  => TunedModel2 -- ^ "tunedModel" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> Permission2 -- ^ "permission2" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  -> UpdateMask -- ^ "updateMask" -  Required. The list of fields to update. Accepted ones:  - role (`Permission.role` field)
...
updateTunedModel
  ...
  => TunedModel2 -- ^ "tunedModel2" -  Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.

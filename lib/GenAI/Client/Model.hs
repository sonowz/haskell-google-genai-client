...
data AttributionSourceId = AttributionSourceId
  { attributionSourceIdGroundingPassage :: !(Maybe GroundingPassageId) -- ^ "groundingPassage" - Identifier for an inline passage.
  , attributionSourceIdSemanticRetrieverChunk :: !(Maybe SemanticRetrieverChunk) -- ^ "semanticRetrieverChunk" - Identifier for a &#x60;Chunk&#x60; fetched via Semantic Retriever.
...
data BaseOperation = BaseOperation
  { baseOperationDone :: !(Maybe Bool) -- ^ "done" - If the value is &#x60;false&#x60;, it means the operation is still in progress. If &#x60;true&#x60;, the operation is completed, and either &#x60;error&#x60; or &#x60;response&#x60; is available.
  , baseOperationName :: !(Maybe Text) -- ^ "name" - The server-assigned name, which is only unique within the same service that originally returns it. If you use the default HTTP mapping, the &#x60;name&#x60; should be a resource name ending with &#x60;operations/{unique_id}&#x60;.
  , baseOperationError :: !(Maybe Status) -- ^ "error" - The error result of the operation in case of failure or cancellation.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data BatchCreateChunksRequest = BatchCreateChunksRequest
  { batchCreateChunksRequestRequests :: !([CreateChunkRequest]) -- ^ /Required/ "requests" - Required. The request messages specifying the &#x60;Chunk&#x60;s to create. A maximum of 100 &#x60;Chunk&#x60;s can be created in a batch.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkBatchCreateChunksRequest
  :: [CreateChunkRequest] -- ^ 'batchCreateChunksRequestRequests': Required. The request messages specifying the `Chunk`s to create. A maximum of 100 `Chunk`s can be created in a batch.
  -> BatchCreateChunksRequest
...
data BatchCreateChunksResponse = BatchCreateChunksResponse
  { batchCreateChunksResponseChunks :: !(Maybe [Chunk]) -- ^ "chunks" - &#x60;Chunk&#x60;s created.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data BatchDeleteChunksRequest = BatchDeleteChunksRequest
  { batchDeleteChunksRequestRequests :: !([DeleteChunkRequest]) -- ^ /Required/ "requests" - Required. The request messages specifying the &#x60;Chunk&#x60;s to delete.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkBatchDeleteChunksRequest
  :: [DeleteChunkRequest] -- ^ 'batchDeleteChunksRequestRequests': Required. The request messages specifying the `Chunk`s to delete.
  -> BatchDeleteChunksRequest
...
data BatchEmbedContentsRequest = BatchEmbedContentsRequest
  { batchEmbedContentsRequestRequests :: !([EmbedContentRequest]) -- ^ /Required/ "requests" - Required. Embed requests for the batch. The model in each of these requests must match the model specified &#x60;BatchEmbedContentsRequest.model&#x60;.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkBatchEmbedContentsRequest
  :: [EmbedContentRequest] -- ^ 'batchEmbedContentsRequestRequests': Required. Embed requests for the batch. The model in each of these requests must match the model specified `BatchEmbedContentsRequest.model`.
  -> BatchEmbedContentsRequest
...
data BatchEmbedContentsResponse = BatchEmbedContentsResponse
  { batchEmbedContentsResponseEmbeddings :: !(Maybe [ContentEmbedding]) -- ^ /ReadOnly/ "embeddings" - Output only. The embeddings for each request, in the same order as provided in the batch request.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data BatchEmbedTextRequest = BatchEmbedTextRequest
  { batchEmbedTextRequestRequests :: !(Maybe [EmbedTextRequest]) -- ^ "requests" - Optional. Embed requests for the batch. Only one of &#x60;texts&#x60; or &#x60;requests&#x60; can be set.
  , batchEmbedTextRequestTexts :: !(Maybe [Text]) -- ^ "texts" - Optional. The free-form input texts that the model will turn into an embedding. The current limit is 100 texts, over which an error will be thrown.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data BatchEmbedTextResponse = BatchEmbedTextResponse
  { batchEmbedTextResponseEmbeddings :: !(Maybe [Embedding]) -- ^ /ReadOnly/ "embeddings" - Output only. The embeddings generated from the input text.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data BatchUpdateChunksRequest = BatchUpdateChunksRequest
  { batchUpdateChunksRequestRequests :: !([UpdateChunkRequest]) -- ^ /Required/ "requests" - Required. The request messages specifying the &#x60;Chunk&#x60;s to update. A maximum of 100 &#x60;Chunk&#x60;s can be updated in a batch.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkBatchUpdateChunksRequest
  :: [UpdateChunkRequest] -- ^ 'batchUpdateChunksRequestRequests': Required. The request messages specifying the `Chunk`s to update. A maximum of 100 `Chunk`s can be updated in a batch.
  -> BatchUpdateChunksRequest
...
data BatchUpdateChunksResponse = BatchUpdateChunksResponse
  { batchUpdateChunksResponseChunks :: !(Maybe [Chunk]) -- ^ "chunks" - &#x60;Chunk&#x60;s updated.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Blob = Blob
  { blobData :: !(Maybe ByteArray) -- ^ "data" - Raw bytes for media formats.
  , blobMimeType :: !(Maybe Text) -- ^ "mimeType" - The IANA standard MIME type of the source data. Examples:   - image/png   - image/jpeg If an unsupported MIME type is provided, an error will be returned. For a complete list of supported types, see [Supported file formats](https://ai.google.dev/gemini-api/docs/prompting_with_media#supported_file_formats).
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CachedContent = CachedContent
  { cachedContentTools :: !(Maybe [Tool]) -- ^ "tools" - Optional. Input only. Immutable. A list of &#x60;Tools&#x60; the model may use to generate the next response
  , cachedContentDisplayName :: !(Maybe Text) -- ^ "displayName" - Optional. Immutable. The user-generated meaningful display name of the cached content. Maximum 128 Unicode characters.
  , cachedContentModel :: !(Text) -- ^ /Required/ "model" - Required. Immutable. The name of the &#x60;Model&#x60; to use for cached content Format: &#x60;models/{model}&#x60;
  , cachedContentExpireTime :: !(Maybe DateTime) -- ^ "expireTime" - Timestamp in UTC of when this resource is considered expired. This is *always* provided on output, regardless of what was sent on input.
  , cachedContentUsageMetadata :: !(Maybe CachedContentUsageMetadata) -- ^ /ReadOnly/ "usageMetadata" - Output only. Metadata on the usage of the cached content.
  , cachedContentName :: !(Maybe Text) -- ^ /ReadOnly/ "name" - Output only. Identifier. The resource name referring to the cached content. Format: &#x60;cachedContents/{id}&#x60;
  , cachedContentContents :: !(Maybe [Content]) -- ^ "contents" - Optional. Input only. Immutable. The content to cache.
  , cachedContentSystemInstruction :: !(Maybe Content) -- ^ "systemInstruction" - Optional. Input only. Immutable. Developer set system instruction. Currently text only.
  , cachedContentToolConfig :: !(Maybe ToolConfig) -- ^ "toolConfig" - Optional. Input only. Immutable. Tool config. This config is shared for all tools.
  , cachedContentCreateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "createTime" - Output only. Creation time of the cache entry.
  , cachedContentTtl :: !(Maybe Text) -- ^ "ttl" - Input only. New TTL for this resource, input only.
  , cachedContentUpdateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "updateTime" - Output only. When the cache entry was last updated in UTC time.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkCachedContent
  :: Text -- ^ 'cachedContentModel': Required. Immutable. The name of the `Model` to use for cached content Format: `models/{model}`
  -> CachedContent
...
data CachedContentUsageMetadata = CachedContentUsageMetadata
  { cachedContentUsageMetadataTotalTokenCount :: !(Maybe Int) -- ^ "totalTokenCount" - Total number of tokens that the cached content consumes.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Candidate = Candidate
  { candidateCitationMetadata :: !(Maybe CitationMetadata) -- ^ /ReadOnly/ "citationMetadata" - Output only. Citation information for model-generated candidate.  This field may be populated with recitation information for any text included in the &#x60;content&#x60;. These are passages that are \&quot;recited\&quot; from copyrighted material in the foundational LLM&#39;s training data.
  , candidateGroundingMetadata :: !(Maybe GroundingMetadata) -- ^ /ReadOnly/ "groundingMetadata" - Output only. Grounding metadata for the candidate.  This field is populated for &#x60;GenerateContent&#x60; calls.
  , candidateUrlContextMetadata :: !(Maybe UrlContextMetadata) -- ^ /ReadOnly/ "urlContextMetadata" - Output only. Metadata related to url context retrieval tool.
  , candidateGroundingAttributions :: !(Maybe [GroundingAttribution]) -- ^ /ReadOnly/ "groundingAttributions" - Output only. Attribution information for sources that contributed to a grounded answer.  This field is populated for &#x60;GenerateAnswer&#x60; calls.
  , candidateLogprobsResult :: !(Maybe LogprobsResult) -- ^ /ReadOnly/ "logprobsResult" - Output only. Log-likelihood scores for the response tokens and top tokens
  , candidateContent :: !(Maybe Content) -- ^ /ReadOnly/ "content" - Output only. Generated content returned from the model.
  , candidateAvgLogprobs :: !(Maybe Double) -- ^ /ReadOnly/ "avgLogprobs" - Output only. Average log probability score of the candidate.
  , candidateIndex :: !(Maybe Int) -- ^ /ReadOnly/ "index" - Output only. Index of the candidate in the list of response candidates.
  , candidateFinishReason :: !(Maybe E'FinishReason) -- ^ /ReadOnly/ "finishReason" - Optional. Output only. The reason why the model stopped generating tokens.  If empty, the model has not stopped generating tokens.
  , candidateSafetyRatings :: !(Maybe [SafetyRating]) -- ^ "safetyRatings" - List of ratings for the safety of a response candidate.  There is at most one rating per category.
  , candidateTokenCount :: !(Maybe Int) -- ^ /ReadOnly/ "tokenCount" - Output only. Token count for this candidate.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Chunk = Chunk
  { chunkCreateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "createTime" - Output only. The Timestamp of when the &#x60;Chunk&#x60; was created.
  , chunkCustomMetadata :: !(Maybe [CustomMetadata]) -- ^ "customMetadata" - Optional. User provided custom metadata stored as key-value pairs. The maximum number of &#x60;CustomMetadata&#x60; per chunk is 20.
  , chunkData :: !(ChunkData) -- ^ /Required/ "data" - Required. The content for the &#x60;Chunk&#x60;, such as the text string. The maximum number of tokens per chunk is 2043.
  , chunkUpdateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "updateTime" - Output only. The Timestamp of when the &#x60;Chunk&#x60; was last updated.
  , chunkState :: !(Maybe E'State4) -- ^ /ReadOnly/ "state" - Output only. Current state of the &#x60;Chunk&#x60;.
  , chunkName :: !(Maybe Text) -- ^ "name" - Immutable. Identifier. The &#x60;Chunk&#x60; resource name. The ID (name excluding the \&quot;corpora/*/documents/*/chunks/\&quot; prefix) can contain up to 40 characters that are lowercase alphanumeric or dashes (-). The ID cannot start or end with a dash. If the name is empty on create, a random 12-character unique ID will be generated. Example: &#x60;corpora/{corpus_id}/documents/{document_id}/chunks/123a456b789c&#x60;
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkChunk
  :: ChunkData -- ^ 'chunkData': Required. The content for the `Chunk`, such as the text string. The maximum number of tokens per chunk is 2043.
  -> Chunk
mkChunk chunkData =
  Chunk
...
data ChunkData = ChunkData
  { chunkDataStringValue :: !(Maybe Text) -- ^ "stringValue" - The &#x60;Chunk&#x60; content as a string. The maximum number of tokens per chunk is 2043.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CitationMetadata = CitationMetadata
  { citationMetadataCitationSources :: !(Maybe [CitationSource]) -- ^ "citationSources" - Citations to sources for a specific response.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CitationSource = CitationSource
  { citationSourceStartIndex :: !(Maybe Int) -- ^ "startIndex" - Optional. Start of segment of the response that is attributed to this source.  Index indicates the start of the segment, measured in bytes.
  , citationSourceUri :: !(Maybe Text) -- ^ "uri" - Optional. URI that is attributed as a source for a portion of the text.
  , citationSourceEndIndex :: !(Maybe Int) -- ^ "endIndex" - Optional. End of the attributed segment, exclusive.
  , citationSourceLicense :: !(Maybe Text) -- ^ "license" - Optional. License for the GitHub project that is attributed as a source for segment.  License info is required for code citations.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CodeExecutionResult = CodeExecutionResult
  { codeExecutionResultOutcome :: !(E'Outcome) -- ^ /Required/ "outcome" - Required. Outcome of the code execution.
  , codeExecutionResultOutput :: !(Maybe Text) -- ^ "output" - Optional. Contains stdout when code execution is successful, stderr or other description otherwise.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkCodeExecutionResult
  :: E'Outcome -- ^ 'codeExecutionResultOutcome': Required. Outcome of the code execution.
  -> CodeExecutionResult
...
data Condition = Condition
  { conditionNumericValue :: !(Maybe Float) -- ^ "numericValue" - The numeric value to filter the metadata on.
  , conditionOperation :: !(E'Operation) -- ^ /Required/ "operation" - Required. Operator applied to the given key-value pair to trigger the condition.
  , conditionStringValue :: !(Maybe Text) -- ^ "stringValue" - The string value to filter the metadata on.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkCondition
  :: E'Operation -- ^ 'conditionOperation': Required. Operator applied to the given key-value pair to trigger the condition.
  -> Condition
...
data Content = Content
  { contentParts :: !(Maybe [Part]) -- ^ "parts" - Ordered &#x60;Parts&#x60; that constitute a single message. Parts may have different MIME types.
  , contentRole :: !(Maybe Text) -- ^ "role" - Optional. The producer of the content. Must be either &#39;user&#39; or &#39;model&#39;.  Useful to set for multi-turn conversations, otherwise can be left blank or unset.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ContentEmbedding = ContentEmbedding
  { contentEmbeddingValues :: !(Maybe [Float]) -- ^ "values" - The embedding values.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ContentFilter = ContentFilter
  { contentFilterReason :: !(Maybe E'Reason) -- ^ "reason" - The reason content was blocked during request processing.
  , contentFilterMessage :: !(Maybe Text) -- ^ "message" - A string that describes the filtering behavior in more detail.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Corpus = Corpus
  { corpusUpdateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "updateTime" - Output only. The Timestamp of when the &#x60;Corpus&#x60; was last updated.
  , corpusCreateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "createTime" - Output only. The Timestamp of when the &#x60;Corpus&#x60; was created.
  , corpusDisplayName :: !(Maybe Text) -- ^ "displayName" - Optional. The human-readable display name for the &#x60;Corpus&#x60;. The display name must be no more than 512 characters in length, including spaces. Example: \&quot;Docs on Semantic Retriever\&quot;
...
data CountMessageTokensRequest = CountMessageTokensRequest
  { countMessageTokensRequestPrompt :: !(MessagePrompt) -- ^ /Required/ "prompt" - Required. The prompt, whose token count is to be returned.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkCountMessageTokensRequest
  :: MessagePrompt -- ^ 'countMessageTokensRequestPrompt': Required. The prompt, whose token count is to be returned.
  -> CountMessageTokensRequest
...
data CountMessageTokensResponse = CountMessageTokensResponse
  { countMessageTokensResponseTokenCount :: !(Maybe Int) -- ^ "tokenCount" - The number of tokens that the &#x60;model&#x60; tokenizes the &#x60;prompt&#x60; into.  Always non-negative.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CountTextTokensRequest = CountTextTokensRequest
  { countTextTokensRequestPrompt :: !(TextPrompt) -- ^ /Required/ "prompt" - Required. The free-form input text given to the model as a prompt.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkCountTextTokensRequest
  :: TextPrompt -- ^ 'countTextTokensRequestPrompt': Required. The free-form input text given to the model as a prompt.
  -> CountTextTokensRequest
...
data CountTextTokensResponse = CountTextTokensResponse
  { countTextTokensResponseTokenCount :: !(Maybe Int) -- ^ "tokenCount" - The number of tokens that the &#x60;model&#x60; tokenizes the &#x60;prompt&#x60; into.  Always non-negative.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CountTokensResponse = CountTokensResponse
  { countTokensResponseCacheTokensDetails :: !(Maybe [ModalityTokenCount]) -- ^ /ReadOnly/ "cacheTokensDetails" - Output only. List of modalities that were processed in the cached content.
  , countTokensResponsePromptTokensDetails :: !(Maybe [ModalityTokenCount]) -- ^ /ReadOnly/ "promptTokensDetails" - Output only. List of modalities that were processed in the request input.
  , countTokensResponseTotalTokens :: !(Maybe Int) -- ^ "totalTokens" - The number of tokens that the &#x60;Model&#x60; tokenizes the &#x60;prompt&#x60; into. Always non-negative.
  , countTokensResponseCachedContentTokenCount :: !(Maybe Int) -- ^ "cachedContentTokenCount" - Number of tokens in the cached part of the prompt (the cached content).
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CreateChunkRequest = CreateChunkRequest
  { createChunkRequestParent :: !(Text) -- ^ /Required/ "parent" - Required. The name of the &#x60;Document&#x60; where this &#x60;Chunk&#x60; will be created. Example: &#x60;corpora/my-corpus-123/documents/the-doc-abc&#x60;
  , createChunkRequestChunk :: !(Chunk) -- ^ /Required/ "chunk" - Required. The &#x60;Chunk&#x60; to create.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkCreateChunkRequest
  :: Text -- ^ 'createChunkRequestParent': Required. The name of the `Document` where this `Chunk` will be created. Example: `corpora/my-corpus-123/documents/the-doc-abc`
  -> Chunk -- ^ 'createChunkRequestChunk': Required. The `Chunk` to create.
  -> CreateChunkRequest
...
data CreateFileRequest = CreateFileRequest
  { createFileRequestFile :: !(Maybe File) -- ^ "file" - Optional. Metadata for the file to create.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CreateFileResponse = CreateFileResponse
  { createFileResponseFile :: !(Maybe File) -- ^ "file" - Metadata for the created file.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CreateTunedModelMetadata = CreateTunedModelMetadata
  { createTunedModelMetadataCompletedPercent :: !(Maybe Float) -- ^ "completedPercent" - The completed percentage for the tuning operation.
  , createTunedModelMetadataCompletedSteps :: !(Maybe Int) -- ^ "completedSteps" - The number of steps completed.
  , createTunedModelMetadataTotalSteps :: !(Maybe Int) -- ^ "totalSteps" - The total number of tuning steps.
  , createTunedModelMetadataSnapshots :: !(Maybe [TuningSnapshot]) -- ^ "snapshots" - Metrics collected during tuning.
  , createTunedModelMetadataTunedModel :: !(Maybe Text) -- ^ "tunedModel" - Name of the tuned model associated with the tuning operation.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CreateTunedModelOperation = CreateTunedModelOperation
  { createTunedModelOperationDone :: !(Maybe Bool) -- ^ "done" - If the value is &#x60;false&#x60;, it means the operation is still in progress. If &#x60;true&#x60;, the operation is completed, and either &#x60;error&#x60; or &#x60;response&#x60; is available.
  , createTunedModelOperationName :: !(Maybe Text) -- ^ "name" - The server-assigned name, which is only unique within the same service that originally returns it. If you use the default HTTP mapping, the &#x60;name&#x60; should be a resource name ending with &#x60;operations/{unique_id}&#x60;.
  , createTunedModelOperationError :: !(Maybe Status) -- ^ "error" - The error result of the operation in case of failure or cancellation.
  , createTunedModelOperationMetadata :: !(Maybe CreateTunedModelMetadata) -- ^ "metadata"
  , createTunedModelOperationResponse :: !(Maybe TunedModel) -- ^ "response"
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CustomMetadata = CustomMetadata
  { customMetadataStringListValue :: !(Maybe StringList) -- ^ "stringListValue" - The StringList value of the metadata to store.
  , customMetadataStringValue :: !(Maybe Text) -- ^ "stringValue" - The string value of the metadata to store.
  , customMetadataKey :: !(Text) -- ^ /Required/ "key" - Required. The key of the metadata to store.
  , customMetadataNumericValue :: !(Maybe Float) -- ^ "numericValue" - The numeric value of the metadata to store.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkCustomMetadata
  :: Text -- ^ 'customMetadataKey': Required. The key of the metadata to store.
  -> CustomMetadata
...
data Dataset = Dataset
  { datasetExamples :: !(Maybe TuningExamples) -- ^ "examples" - Optional. Inline examples with simple input/output text.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data DeleteChunkRequest = DeleteChunkRequest
  { deleteChunkRequestName :: !(Text) -- ^ /Required/ "name" - Required. The resource name of the &#x60;Chunk&#x60; to delete. Example: &#x60;corpora/my-corpus-123/documents/the-doc-abc/chunks/some-chunk&#x60;
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkDeleteChunkRequest
  :: Text -- ^ 'deleteChunkRequestName': Required. The resource name of the `Chunk` to delete. Example: `corpora/my-corpus-123/documents/the-doc-abc/chunks/some-chunk`
  -> DeleteChunkRequest
...
data Document = Document
  { documentUpdateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "updateTime" - Output only. The Timestamp of when the &#x60;Document&#x60; was last updated.
  , documentName :: !(Maybe Text) -- ^ "name" - Immutable. Identifier. The &#x60;Document&#x60; resource name. The ID (name excluding the \&quot;corpora/*/documents/\&quot; prefix) can contain up to 40 characters that are lowercase alphanumeric or dashes (-). The ID cannot start or end with a dash. If the name is empty on create, a unique name will be derived from &#x60;display_name&#x60; along with a 12 character random suffix. Example: &#x60;corpora/{corpus_id}/documents/my-awesome-doc-123a456b789c&#x60;
  , documentCustomMetadata :: !(Maybe [CustomMetadata]) -- ^ "customMetadata" - Optional. User provided custom metadata stored as key-value pairs used for querying. A &#x60;Document&#x60; can have a maximum of 20 &#x60;CustomMetadata&#x60;.
  , documentCreateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "createTime" - Output only. The Timestamp of when the &#x60;Document&#x60; was created.
  , documentDisplayName :: !(Maybe Text) -- ^ "displayName" - Optional. The human-readable display name for the &#x60;Document&#x60;. The display name must be no more than 512 characters in length, including spaces. Example: \&quot;Semantic Retriever Documentation\&quot;
  } deriving (P.Show, P.Eq, P.Typeable)
...
data DynamicRetrievalConfig = DynamicRetrievalConfig
  { dynamicRetrievalConfigDynamicThreshold :: !(Maybe Float) -- ^ "dynamicThreshold" - The threshold to be used in dynamic retrieval. If not set, a system default value is used.
  , dynamicRetrievalConfigMode :: !(Maybe E'Mode) -- ^ "mode" - The mode of the predictor to be used in dynamic retrieval.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data EmbedContentRequest = EmbedContentRequest
  { embedContentRequestTaskType :: !(Maybe TaskType) -- ^ "taskType" - Optional. Optional task type for which the embeddings will be used. Not supported on earlier models (&#x60;models/embedding-001&#x60;).
  , embedContentRequestContent :: !(Content) -- ^ /Required/ "content" - Required. The content to embed. Only the &#x60;parts.text&#x60; fields will be counted.
  , embedContentRequestOutputDimensionality :: !(Maybe Int) -- ^ "outputDimensionality" - Optional. Optional reduced dimension for the output embedding. If set, excessive values in the output embedding are truncated from the end. Supported by newer models since 2024 only. You cannot set this value if using the earlier model (&#x60;models/embedding-001&#x60;).
  , embedContentRequestModel :: !(Text) -- ^ /Required/ "model" - Required. The model&#39;s resource name. This serves as an ID for the Model to use.  This name should match a model name returned by the &#x60;ListModels&#x60; method.  Format: &#x60;models/{model}&#x60;
  , embedContentRequestTitle :: !(Maybe Text) -- ^ "title" - Optional. An optional title for the text. Only applicable when TaskType is &#x60;RETRIEVAL_DOCUMENT&#x60;.  Note: Specifying a &#x60;title&#x60; for &#x60;RETRIEVAL_DOCUMENT&#x60; provides better quality embeddings for retrieval.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkEmbedContentRequest
  :: Content -- ^ 'embedContentRequestContent': Required. The content to embed. Only the `parts.text` fields will be counted.
  -> Text -- ^ 'embedContentRequestModel': Required. The model's resource name. This serves as an ID for the Model to use.  This name should match a model name returned by the `ListModels` method.  Format: `models/{model}`
  -> EmbedContentRequest
...
data EmbedContentResponse = EmbedContentResponse
  { embedContentResponseEmbedding :: !(Maybe ContentEmbedding) -- ^ /ReadOnly/ "embedding" - Output only. The embedding generated from the input content.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data EmbedTextRequest = EmbedTextRequest
  { embedTextRequestText :: !(Maybe Text) -- ^ "text" - Optional. The free-form input text that the model will turn into an embedding.
  , embedTextRequestModel :: !(Text) -- ^ /Required/ "model" - Required. The model name to use with the format model&#x3D;models/{model}.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkEmbedTextRequest
  :: Text -- ^ 'embedTextRequestModel': Required. The model name to use with the format model=models/{model}.
  -> EmbedTextRequest
...
data EmbedTextResponse = EmbedTextResponse
  { embedTextResponseEmbedding :: !(Maybe Embedding) -- ^ /ReadOnly/ "embedding" - Output only. The embedding generated from the input text.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Embedding = Embedding
  { embeddingValue :: !(Maybe [Float]) -- ^ "value" - The embedding values.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Example = Example
  { exampleOutput :: !(Message) -- ^ /Required/ "output" - Required. An example of what the model should output given the input.
  , exampleInput :: !(Message) -- ^ /Required/ "input" - Required. An example of an input &#x60;Message&#x60; from the user.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkExample
  :: Message -- ^ 'exampleOutput': Required. An example of what the model should output given the input.
  -> Message -- ^ 'exampleInput': Required. An example of an input `Message` from the user.
  -> Example
...
data ExecutableCode = ExecutableCode
  { executableCodeLanguage :: !(E'Language) -- ^ /Required/ "language" - Required. Programming language of the &#x60;code&#x60;.
  , executableCodeCode :: !(Text) -- ^ /Required/ "code" - Required. The code to be executed.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkExecutableCode
  :: E'Language -- ^ 'executableCodeLanguage': Required. Programming language of the `code`.
  -> Text -- ^ 'executableCodeCode': Required. The code to be executed.
  -> ExecutableCode
...
data File = File
  { fileUri :: !(Maybe Text) -- ^ /ReadOnly/ "uri" - Output only. The uri of the &#x60;File&#x60;.
  , fileName :: !(Maybe Text) -- ^ "name" - Immutable. Identifier. The &#x60;File&#x60; resource name. The ID (name excluding the \&quot;files/\&quot; prefix) can contain up to 40 characters that are lowercase alphanumeric or dashes (-). The ID cannot start or end with a dash. If the name is empty on create, a unique name will be generated. Example: &#x60;files/123-456&#x60;
  , fileExpirationTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "expirationTime" - Output only. The timestamp of when the &#x60;File&#x60; will be deleted. Only set if the &#x60;File&#x60; is scheduled to expire.
  , fileDisplayName :: !(Maybe Text) -- ^ "displayName" - Optional. The human-readable display name for the &#x60;File&#x60;. The display name must be no more than 512 characters in length, including spaces. Example: \&quot;Welcome Image\&quot;
  , fileVideoMetadata :: !(Maybe VideoFileMetadata) -- ^ /ReadOnly/ "videoMetadata" - Output only. Metadata for a video.
  , fileState :: !(Maybe E'State) -- ^ /ReadOnly/ "state" - Output only. Processing state of the File.
  , fileSource :: !(Maybe E'Source) -- ^ "source" - Source of the File.
  , fileMimeType :: !(Maybe Text) -- ^ /ReadOnly/ "mimeType" - Output only. MIME type of the file.
  , fileCreateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "createTime" - Output only. The timestamp of when the &#x60;File&#x60; was created.
  , fileError :: !(Maybe Status) -- ^ /ReadOnly/ "error" - Output only. Error status if File processing failed.
  , fileDownloadUri :: !(Maybe Text) -- ^ /ReadOnly/ "downloadUri" - Output only. The download uri of the &#x60;File&#x60;.
  , fileSizeBytes :: !(Maybe Text) -- ^ /ReadOnly/ "sizeBytes" - Output only. Size of the file in bytes.
  , fileSha256Hash :: !(Maybe ByteArray) -- ^ /ReadOnly/ "sha256Hash" - Output only. SHA-256 hash of the uploaded bytes.
  , fileUpdateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "updateTime" - Output only. The timestamp of when the &#x60;File&#x60; was last updated.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data FileData = FileData
  { fileDataMimeType :: !(Maybe Text) -- ^ "mimeType" - Optional. The IANA standard MIME type of the source data.
  , fileDataFileUri :: !(Text) -- ^ /Required/ "fileUri" - Required. URI.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkFileData
  :: Text -- ^ 'fileDataFileUri': Required. URI.
  -> FileData
...
mkFunctionCall
  :: Text -- ^ 'functionCallName': Required. The name of the function to call. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 63.
  -> FunctionCall
...
data FunctionDeclaration = FunctionDeclaration
  { functionDeclarationParameters :: !(Maybe Schema) -- ^ "parameters" - Optional. Describes the parameters to this function. Reflects the Open API 3.03 Parameter Object string Key: the name of the parameter. Parameter names are case sensitive. Schema Value: the Schema defining the type used for the parameter.
  , functionDeclarationName :: !(Text) -- ^ /Required/ "name" - Required. The name of the function. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 63.
...
mkFunctionDeclaration
  :: Text -- ^ 'functionDeclarationName': Required. The name of the function. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 63.
  -> Text -- ^ 'functionDeclarationDescription': Required. A brief description of the function.
  -> FunctionDeclaration
...
data FunctionResponse = FunctionResponse
  { functionResponseScheduling :: !(Maybe E'Scheduling) -- ^ "scheduling" - Optional. Specifies how the response should be scheduled in the conversation. Only applicable to NON_BLOCKING function calls, is ignored otherwise. Defaults to WHEN_IDLE.
...
data GenerateAnswerRequest = GenerateAnswerRequest
  { generateAnswerRequestSemanticRetriever :: !(Maybe SemanticRetrieverConfig) -- ^ "semanticRetriever" - Content retrieved from resources created via the Semantic Retriever API.
  ...
  , generateAnswerRequestAnswerStyle :: !(E'AnswerStyle) -- ^ /Required/ "answerStyle" - Required. Style in which answers should be returned.
  , generateAnswerRequestContents :: !([Content]) -- ^ /Required/ "contents" - Required. The content of the current conversation with the &#x60;Model&#x60;. For single-turn queries, this is a single question to answer. For multi-turn queries, this is a repeated field that contains conversation history and the last &#x60;Content&#x60; in the list containing the question.  Note: &#x60;GenerateAnswer&#x60; only supports queries in English.
  , generateAnswerRequestSafetySettings :: !(Maybe [SafetySetting]) -- ^ "safetySettings" - Optional. A list of unique &#x60;SafetySetting&#x60; instances for blocking unsafe content.  This will be enforced on the &#x60;GenerateAnswerRequest.contents&#x60; and &#x60;GenerateAnswerResponse.candidate&#x60;. There should not be more than one setting for each &#x60;SafetyCategory&#x60; type. The API will block any contents and responses that fail to meet the thresholds set by these settings. This list overrides the default settings for each &#x60;SafetyCategory&#x60; specified in the safety_settings. If there is no &#x60;SafetySetting&#x60; for a given &#x60;SafetyCategory&#x60; provided in the list, the API will use the default safety setting for that category. Harm categories HARM_CATEGORY_HATE_SPEECH, HARM_CATEGORY_SEXUALLY_EXPLICIT, HARM_CATEGORY_DANGEROUS_CONTENT, HARM_CATEGORY_HARASSMENT are supported. Refer to the [guide](https://ai.google.dev/gemini-api/docs/safety-settings) for detailed information on available safety settings. Also refer to the [Safety guidance](https://ai.google.dev/gemini-api/docs/safety-guidance) to learn how to incorporate safety considerations in your AI applications.
  , generateAnswerRequestInlinePassages :: !(Maybe GroundingPassages) -- ^ "inlinePassages" - Passages provided inline with the request.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGenerateAnswerRequest
  :: E'AnswerStyle -- ^ 'generateAnswerRequestAnswerStyle': Required. Style in which answers should be returned.
  -> [Content] -- ^ 'generateAnswerRequestContents': Required. The content of the current conversation with the `Model`. For single-turn queries, this is a single question to answer. For multi-turn queries, this is a repeated field that contains conversation history and the last `Content` in the list containing the question.  Note: `GenerateAnswer` only supports queries in English.
  -> GenerateAnswerRequest
...
data GenerateAnswerResponse = GenerateAnswerResponse
  ...
  , generateAnswerResponseAnswerableProbability :: !(Maybe Float) -- ^ /ReadOnly/ "answerableProbability" - Output only. The model&#39;s estimate of the probability that its answer is correct and grounded in the input passages.  A low &#x60;answerable_probability&#x60; indicates that the answer might not be grounded in the sources.  When &#x60;answerable_probability&#x60; is low, you may want to:  * Display a message to the effect of \&quot;We couldn’t answer that question\&quot; to the user. * Fall back to a general-purpose LLM that answers the question from world knowledge. The threshold and nature of such fallbacks will depend on individual use cases. &#x60;0.5&#x60; is a good starting threshold.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GenerateContentRequest = GenerateContentRequest
  { generateContentRequestToolConfig :: !(Maybe ToolConfig) -- ^ "toolConfig" - Optional. Tool configuration for any &#x60;Tool&#x60; specified in the request. Refer to the [Function calling guide](https://ai.google.dev/gemini-api/docs/function-calling#function_calling_mode) for a usage example.
  , generateContentRequestTools :: !(Maybe [Tool]) -- ^ "tools" - Optional. A list of &#x60;Tools&#x60; the &#x60;Model&#x60; may use to generate the next response.  A &#x60;Tool&#x60; is a piece of code that enables the system to interact with external systems to perform an action, or set of actions, outside of knowledge and scope of the &#x60;Model&#x60;. Supported &#x60;Tool&#x60;s are &#x60;Function&#x60; and &#x60;code_execution&#x60;. Refer to the [Function calling](https://ai.google.dev/gemini-api/docs/function-calling) and the [Code execution](https://ai.google.dev/gemini-api/docs/code-execution) guides to learn more.
  , generateContentRequestContents :: !([Content]) -- ^ /Required/ "contents" - Required. The content of the current conversation with the model.  For single-turn queries, this is a single instance. For multi-turn queries like [chat](https://ai.google.dev/gemini-api/docs/text-generation#chat), this is a repeated field that contains the conversation history and the latest request.
  , generateContentRequestSystemInstruction :: !(Maybe Content) -- ^ "systemInstruction" - Optional. Developer set [system instruction(s)](https://ai.google.dev/gemini-api/docs/system-instructions). Currently, text only.
  , generateContentRequestCachedContent :: !(Maybe Text) -- ^ "cachedContent" - Optional. The name of the content [cached](https://ai.google.dev/gemini-api/docs/caching) to use as context to serve the prediction. Format: &#x60;cachedContents/{cachedContent}&#x60;
  , generateContentRequestSafetySettings :: !(Maybe [SafetySetting]) -- ^ "safetySettings" - Optional. A list of unique &#x60;SafetySetting&#x60; instances for blocking unsafe content.  This will be enforced on the &#x60;GenerateContentRequest.contents&#x60; and &#x60;GenerateContentResponse.candidates&#x60;. There should not be more than one setting for each &#x60;SafetyCategory&#x60; type. The API will block any contents and responses that fail to meet the thresholds set by these settings. This list overrides the default settings for each &#x60;SafetyCategory&#x60; specified in the safety_settings. If there is no &#x60;SafetySetting&#x60; for a given &#x60;SafetyCategory&#x60; provided in the list, the API will use the default safety setting for that category. Harm categories HARM_CATEGORY_HATE_SPEECH, HARM_CATEGORY_SEXUALLY_EXPLICIT, HARM_CATEGORY_DANGEROUS_CONTENT, HARM_CATEGORY_HARASSMENT, HARM_CATEGORY_CIVIC_INTEGRITY are supported. Refer to the [guide](https://ai.google.dev/gemini-api/docs/safety-settings) for detailed information on available safety settings. Also refer to the [Safety guidance](https://ai.google.dev/gemini-api/docs/safety-guidance) to learn how to incorporate safety considerations in your AI applications.
  , generateContentRequestModel :: !(Text) -- ^ /Required/ "model" - Required. The name of the &#x60;Model&#x60; to use for generating the completion.  Format: &#x60;models/{model}&#x60;.
  , generateContentRequestGenerationConfig :: !(Maybe GenerationConfig) -- ^ "generationConfig" - Optional. Configuration options for model generation and outputs.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGenerateContentRequest
  :: [Content] -- ^ 'generateContentRequestContents': Required. The content of the current conversation with the model.  For single-turn queries, this is a single instance. For multi-turn queries like [chat](https://ai.google.dev/gemini-api/docs/text-generation#chat), this is a repeated field that contains the conversation history and the latest request.
  -> Text -- ^ 'generateContentRequestModel': Required. The name of the `Model` to use for generating the completion.  Format: `models/{model}`.
  -> GenerateContentRequest
...
data GenerateContentResponse = GenerateContentResponse
  { generateContentResponseCandidates :: !(Maybe [Candidate]) -- ^ "candidates" - Candidate responses from the model.
  , generateContentResponseUsageMetadata :: !(Maybe UsageMetadata) -- ^ /ReadOnly/ "usageMetadata" - Output only. Metadata on the generation requests&#39; token usage.
  , generateContentResponseModelVersion :: !(Maybe Text) -- ^ /ReadOnly/ "modelVersion" - Output only. The model version used to generate the response.
  , generateContentResponsePromptFeedback :: !(Maybe PromptFeedback) -- ^ "promptFeedback" - Returns the prompt&#39;s feedback related to the content filters.
  , generateContentResponseResponseId :: !(Maybe Text) -- ^ /ReadOnly/ "responseId" - Output only. response_id is used to identify each response.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GenerateMessageRequest = GenerateMessageRequest
  ...
  , generateMessageRequestTopP :: !(Maybe Float) -- ^ "topP" - Optional. The maximum cumulative probability of tokens to consider when sampling.  The model uses combined Top-k and nucleus sampling.  Nucleus sampling considers the smallest set of tokens whose probability sum is at least &#x60;top_p&#x60;.
  , generateMessageRequestCandidateCount :: !(Maybe Int) -- ^ "candidateCount" - Optional. The number of generated response messages to return.  This value must be between &#x60;[1, 8]&#x60;, inclusive. If unset, this will default to &#x60;1&#x60;.
  , generateMessageRequestTopK :: !(Maybe Int) -- ^ "topK" - Optional. The maximum number of tokens to consider when sampling.  The model uses combined Top-k and nucleus sampling.  Top-k sampling considers the set of &#x60;top_k&#x60; most probable tokens.
  , generateMessageRequestPrompt :: !(MessagePrompt) -- ^ /Required/ "prompt" - Required. The structured textual input given to the model as a prompt.  Given a prompt, the model will return what it predicts is the next message in the discussion.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGenerateMessageRequest
  :: MessagePrompt -- ^ 'generateMessageRequestPrompt': Required. The structured textual input given to the model as a prompt.  Given a prompt, the model will return what it predicts is the next message in the discussion.
  -> GenerateMessageRequest
...
data GenerateMessageResponse = GenerateMessageResponse
  { generateMessageResponseCandidates :: !(Maybe [Message]) -- ^ "candidates" - Candidate response messages from the model.
  , generateMessageResponseMessages :: !(Maybe [Message]) -- ^ "messages" - The conversation history used by the model.
  , generateMessageResponseFilters :: !(Maybe [ContentFilter]) -- ^ "filters" - A set of content filtering metadata for the prompt and response text.  This indicates which &#x60;SafetyCategory&#x60;(s) blocked a candidate from this response, the lowest &#x60;HarmProbability&#x60; that triggered a block, and the HarmThreshold setting for that category.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GenerateTextRequest = GenerateTextRequest
  { generateTextRequestStopSequences :: !(Maybe [Text]) -- ^ "stopSequences" - The set of character sequences (up to 5) that will stop output generation. If specified, the API will stop at the first appearance of a stop sequence. The stop sequence will not be included as part of the response.
  , generateTextRequestPrompt :: !(TextPrompt) -- ^ /Required/ "prompt" - Required. The free-form input text given to the model as a prompt.  Given a prompt, the model will generate a TextCompletion response it predicts as the completion of the input text.
  , generateTextRequestMaxOutputTokens :: !(Maybe Int) -- ^ "maxOutputTokens" - Optional. The maximum number of tokens to include in a candidate.  If unset, this will default to output_token_limit specified in the &#x60;Model&#x60; specification.
  , generateTextRequestSafetySettings :: !(Maybe [SafetySetting]) -- ^ "safetySettings" - Optional. A list of unique &#x60;SafetySetting&#x60; instances for blocking unsafe content.  that will be enforced on the &#x60;GenerateTextRequest.prompt&#x60; and &#x60;GenerateTextResponse.candidates&#x60;. There should not be more than one setting for each &#x60;SafetyCategory&#x60; type. The API will block any prompts and responses that fail to meet the thresholds set by these settings. This list overrides the default settings for each &#x60;SafetyCategory&#x60; specified in the safety_settings. If there is no &#x60;SafetySetting&#x60; for a given &#x60;SafetyCategory&#x60; provided in the list, the API will use the default safety setting for that category. Harm categories HARM_CATEGORY_DEROGATORY, HARM_CATEGORY_TOXICITY, HARM_CATEGORY_VIOLENCE, HARM_CATEGORY_SEXUAL, HARM_CATEGORY_MEDICAL, HARM_CATEGORY_DANGEROUS are supported in text service.
  , generateTextRequestTemperature :: !(Maybe Float) -- ^ "temperature" - Optional. Controls the randomness of the output. Note: The default value varies by model, see the &#x60;Model.temperature&#x60; attribute of the &#x60;Model&#x60; returned the &#x60;getModel&#x60; function.  Values can range from [0.0,1.0], inclusive. A value closer to 1.0 will produce responses that are more varied and creative, while a value closer to 0.0 will typically result in more straightforward responses from the model.
  , generateTextRequestTopK :: !(Maybe Int) -- ^ "topK" - Optional. The maximum number of tokens to consider when sampling.  The model uses combined Top-k and nucleus sampling.  Top-k sampling considers the set of &#x60;top_k&#x60; most probable tokens. Defaults to 40.  Note: The default value varies by model, see the &#x60;Model.top_k&#x60; attribute of the &#x60;Model&#x60; returned the &#x60;getModel&#x60; function.
  , generateTextRequestTopP :: !(Maybe Float) -- ^ "topP" - Optional. The maximum cumulative probability of tokens to consider when sampling.  The model uses combined Top-k and nucleus sampling.  Tokens are sorted based on their assigned probabilities so that only the most likely tokens are considered. Top-k sampling directly limits the maximum number of tokens to consider, while Nucleus sampling limits number of tokens based on the cumulative probability.  Note: The default value varies by model, see the &#x60;Model.top_p&#x60; attribute of the &#x60;Model&#x60; returned the &#x60;getModel&#x60; function.
  , generateTextRequestCandidateCount :: !(Maybe Int) -- ^ "candidateCount" - Optional. Number of generated responses to return.  This value must be between [1, 8], inclusive. If unset, this will default to 1.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGenerateTextRequest
  :: TextPrompt -- ^ 'generateTextRequestPrompt': Required. The free-form input text given to the model as a prompt.  Given a prompt, the model will generate a TextCompletion response it predicts as the completion of the input text.
  -> GenerateTextRequest
...
data GenerateTextResponse = GenerateTextResponse
  { generateTextResponseSafetyFeedback :: !(Maybe [SafetyFeedback]) -- ^ "safetyFeedback" - Returns any safety feedback related to content filtering.
  , generateTextResponseCandidates :: !(Maybe [TextCompletion]) -- ^ "candidates" - Candidate responses from the model.
...
data GenerateVideoResponse = GenerateVideoResponse
  { generateVideoResponseGeneratedSamples :: !(Maybe [Media]) -- ^ "generatedSamples" - The generated samples.
  , generateVideoResponseRaiMediaFilteredCount :: !(Maybe Int) -- ^ "raiMediaFilteredCount" - Returns if any videos were filtered due to RAI policies.
  , generateVideoResponseRaiMediaFilteredReasons :: !(Maybe [Text]) -- ^ "raiMediaFilteredReasons" - Returns rai failure reasons if any.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GeneratedFile = GeneratedFile
  { generatedFileError :: !(Maybe Status) -- ^ "error" - Error details if the GeneratedFile ends up in the STATE_FAILED state.
  , generatedFileName :: !(Maybe Text) -- ^ "name" - Identifier. The name of the generated file. Example: &#x60;generatedFiles/abc-123&#x60;
  , generatedFileState :: !(Maybe E'State2) -- ^ /ReadOnly/ "state" - Output only. The state of the GeneratedFile.
  , generatedFileMimeType :: !(Maybe Text) -- ^ "mimeType" - MIME type of the generatedFile.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GenerationConfig = GenerationConfig
  { generationConfigResponseSchema :: !(Maybe Schema) -- ^ "responseSchema" - Optional. Output schema of the generated candidate text. Schemas must be a subset of the [OpenAPI schema](https://spec.openapis.org/oas/v3.0.3#schema) and can be objects, primitives or arrays.  If set, a compatible &#x60;response_mime_type&#x60; must also be set. Compatible MIME types: &#x60;application/json&#x60;: Schema for JSON response. Refer to the [JSON text generation guide](https://ai.google.dev/gemini-api/docs/json-mode) for more details.
  , generationConfigThinkingConfig :: !(Maybe ThinkingConfig) -- ^ "thinkingConfig" - Optional. Config for thinking features. An error will be returned if this field is set for models that don&#39;t support thinking.
  , generationConfigLogprobs :: !(Maybe Int) -- ^ "logprobs" - Optional. Only valid if response_logprobs&#x3D;True. This sets the number of top logprobs to return at each decoding step in the Candidate.logprobs_result.
  ...
  , generationConfigTopK :: !(Maybe Int) -- ^ "topK" - Optional. The maximum number of tokens to consider when sampling.  Gemini models use Top-p (nucleus) sampling or a combination of Top-k and nucleus sampling. Top-k sampling considers the set of &#x60;top_k&#x60; most probable tokens. Models running with nucleus sampling don&#39;t allow top_k setting.  Note: The default value varies by &#x60;Model&#x60; and is specified by the&#x60;Model.top_p&#x60; attribute returned from the &#x60;getModel&#x60; function. An empty &#x60;top_k&#x60; attribute indicates that the model doesn&#39;t apply top-k sampling and doesn&#39;t allow setting &#x60;top_k&#x60; on requests.
  , generationConfigCandidateCount :: !(Maybe Int) -- ^ "candidateCount" - Optional. Number of generated responses to return. If unset, this will default to 1. Please note that this doesn&#39;t work for previous generation models (Gemini 1.0 family)
  , generationConfigEnableEnhancedCivicAnswers :: !(Maybe Bool) -- ^ "enableEnhancedCivicAnswers" - Optional. Enables enhanced civic answers. It may not be available for all models.
  , generationConfigResponseLogprobs :: !(Maybe Bool) -- ^ "responseLogprobs" - Optional. If true, export the logprobs results in response.
  , generationConfigResponseModalities :: !(Maybe [E'ResponseModalities]) -- ^ "responseModalities" - Optional. The requested modalities of the response. Represents the set of modalities that the model can return, and should be expected in the response. This is an exact match to the modalities of the response.  A model may have multiple combinations of supported modalities. If the requested modalities do not match any of the supported combinations, an error will be returned.  An empty list is equivalent to requesting only text.
  , generationConfigFrequencyPenalty :: !(Maybe Float) -- ^ "frequencyPenalty" - Optional. Frequency penalty applied to the next token&#39;s logprobs, multiplied by the number of times each token has been seen in the respponse so far.  A positive penalty will discourage the use of tokens that have already been used, proportional to the number of times the token has been used: The more a token is used, the more difficult it is for the model to use that token again increasing the vocabulary of responses.  Caution: A _negative_ penalty will encourage the model to reuse tokens proportional to the number of times the token has been used. Small negative values will reduce the vocabulary of a response. Larger negative values will cause the model to start repeating a common token  until it hits the max_output_tokens limit.
  , generationConfigSeed :: !(Maybe Int) -- ^ "seed" - Optional. Seed used in decoding. If not set, the request uses a randomly generated seed.
  , generationConfigMaxOutputTokens :: !(Maybe Int) -- ^ "maxOutputTokens" - Optional. The maximum number of tokens to include in a response candidate.  Note: The default value varies by model, see the &#x60;Model.output_token_limit&#x60; attribute of the &#x60;Model&#x60; returned from the &#x60;getModel&#x60; function.
  , generationConfigResponseMimeType :: !(Maybe Text) -- ^ "responseMimeType" - Optional. MIME type of the generated candidate text. Supported MIME types are: &#x60;text/plain&#x60;: (default) Text output. &#x60;application/json&#x60;: JSON response in the response candidates. &#x60;text/x.enum&#x60;: ENUM as a string response in the response candidates. Refer to the [docs](https://ai.google.dev/gemini-api/docs/prompting_with_media#plain_text_formats) for a list of all supported text MIME types.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GoogleSearch = GoogleSearch
  { googleSearchTimeRangeFilter :: !(Maybe Interval) -- ^ "timeRangeFilter" - Optional. Filter search results to a specific time range. If customers set a start time, they must set an end time (and vice versa).
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GoogleSearchRetrieval = GoogleSearchRetrieval
  { googleSearchRetrievalDynamicRetrievalConfig :: !(Maybe DynamicRetrievalConfig) -- ^ "dynamicRetrievalConfig" - Specifies the dynamic retrieval configuration for the given source.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GroundingAttribution = GroundingAttribution
  { groundingAttributionSourceId :: !(Maybe AttributionSourceId) -- ^ /ReadOnly/ "sourceId" - Output only. Identifier for the source contributing to this attribution.
  , groundingAttributionContent :: !(Maybe Content) -- ^ "content" - Grounding source content that makes up this attribution.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GroundingChunk = GroundingChunk
  { groundingChunkWeb :: !(Maybe Web) -- ^ "web" - Grounding chunk from the web.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GroundingMetadata = GroundingMetadata
  { groundingMetadataRetrievalMetadata :: !(Maybe RetrievalMetadata) -- ^ "retrievalMetadata" - Metadata related to retrieval in the grounding flow.
  , groundingMetadataWebSearchQueries :: !(Maybe [Text]) -- ^ "webSearchQueries" - Web search queries for the following-up web search.
  , groundingMetadataGroundingChunks :: !(Maybe [GroundingChunk]) -- ^ "groundingChunks" - List of supporting references retrieved from specified grounding source.
  , groundingMetadataSearchEntryPoint :: !(Maybe SearchEntryPoint) -- ^ "searchEntryPoint" - Optional. Google search entry for the following-up web searches.
  , groundingMetadataGroundingSupports :: !(Maybe [GroundingSupport]) -- ^ "groundingSupports" - List of grounding support.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GroundingPassage = GroundingPassage
  { groundingPassageContent :: !(Maybe Content) -- ^ "content" - Content of the passage.
  , groundingPassageId :: !(Maybe Text) -- ^ "id" - Identifier for the passage for attributing this passage in grounded answers.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GroundingPassageId = GroundingPassageId
  { groundingPassageIdPassageId :: !(Maybe Text) -- ^ /ReadOnly/ "passageId" - Output only. ID of the passage matching the &#x60;GenerateAnswerRequest&#x60;&#39;s &#x60;GroundingPassage.id&#x60;.
  , groundingPassageIdPartIndex :: !(Maybe Int) -- ^ /ReadOnly/ "partIndex" - Output only. Index of the part within the &#x60;GenerateAnswerRequest&#x60;&#39;s &#x60;GroundingPassage.content&#x60;.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GroundingPassages = GroundingPassages
  { groundingPassagesPassages :: !(Maybe [GroundingPassage]) -- ^ "passages" - List of passages.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data GroundingSupport = GroundingSupport
  { groundingSupportConfidenceScores :: !(Maybe [Float]) -- ^ "confidenceScores" - Confidence score of the support references. Ranges from 0 to 1. 1 is the most confident. This list must have the same size as the grounding_chunk_indices.
  , groundingSupportGroundingChunkIndices :: !(Maybe [Int]) -- ^ "groundingChunkIndices" - A list of indices (into &#39;grounding_chunk&#39;) specifying the citations associated with the claim. For instance [1,3,4] means that grounding_chunk[1], grounding_chunk[3], grounding_chunk[4] are the retrieved content attributed to the claim.
  , groundingSupportSegment :: !(Maybe Segment) -- ^ "segment" - Segment of the content this support belongs to.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Hyperparameters = Hyperparameters
  { hyperparametersEpochCount :: !(Maybe Int) -- ^ "epochCount" - Immutable. The number of training epochs. An epoch is one pass through the training data. If not set, a default of 5 will be used.
  , hyperparametersLearningRate :: !(Maybe Float) -- ^ "learningRate" - Optional. Immutable. The learning rate hyperparameter for tuning. If not set, a default of 0.001 or 0.0002 will be calculated based on the number of training examples.
  , hyperparametersLearningRateMultiplier :: !(Maybe Float) -- ^ "learningRateMultiplier" - Optional. Immutable. The learning rate multiplier is used to calculate a final learning_rate based on the default (recommended) value. Actual learning rate :&#x3D; learning_rate_multiplier * default learning rate Default learning rate is dependent on base model and dataset size. If not set, a default of 1.0 will be used.
  , hyperparametersBatchSize :: !(Maybe Int) -- ^ "batchSize" - Immutable. The batch size hyperparameter for tuning. If not set, a default of 4 or 16 will be used based on the number of training examples.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data InputFeedback = InputFeedback
  { inputFeedbackSafetyRatings :: !(Maybe [SafetyRating]) -- ^ "safetyRatings" - Ratings for safety of the input. There is at most one rating per category.
  , inputFeedbackBlockReason :: !(Maybe E'BlockReason2) -- ^ "blockReason" - Optional. If set, the input was blocked and no candidates are returned. Rephrase the input.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Interval = Interval
  { intervalStartTime :: !(Maybe DateTime) -- ^ "startTime" - Optional. Inclusive start of the interval.  If specified, a Timestamp matching this interval will have to be the same or after the start.
  , intervalEndTime :: !(Maybe DateTime) -- ^ "endTime" - Optional. Exclusive end of the interval.  If specified, a Timestamp matching this interval will have to be before the end.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListCachedContentsResponse = ListCachedContentsResponse
  { listCachedContentsResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token, which can be sent as &#x60;page_token&#x60; to retrieve the next page. If this field is omitted, there are no subsequent pages.
  , listCachedContentsResponseCachedContents :: !(Maybe [CachedContent]) -- ^ "cachedContents" - List of cached contents.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListChunksResponse = ListChunksResponse
  { listChunksResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token, which can be sent as &#x60;page_token&#x60; to retrieve the next page. If this field is omitted, there are no more pages.
  , listChunksResponseChunks :: !(Maybe [Chunk]) -- ^ "chunks" - The returned &#x60;Chunk&#x60;s.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListCorporaResponse = ListCorporaResponse
  { listCorporaResponseCorpora :: !(Maybe [Corpus]) -- ^ "corpora" - The returned corpora.
  , listCorporaResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token, which can be sent as &#x60;page_token&#x60; to retrieve the next page. If this field is omitted, there are no more pages.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListDocumentsResponse = ListDocumentsResponse
  { listDocumentsResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token, which can be sent as &#x60;page_token&#x60; to retrieve the next page. If this field is omitted, there are no more pages.
  , listDocumentsResponseDocuments :: !(Maybe [Document]) -- ^ "documents" - The returned &#x60;Document&#x60;s.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListFilesResponse = ListFilesResponse
  { listFilesResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token that can be sent as a &#x60;page_token&#x60; into a subsequent &#x60;ListFiles&#x60; call.
  , listFilesResponseFiles :: !(Maybe [File]) -- ^ "files" - The list of &#x60;File&#x60;s.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListGeneratedFilesResponse = ListGeneratedFilesResponse
  { listGeneratedFilesResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token that can be sent as a &#x60;page_token&#x60; into a subsequent &#x60;ListGeneratedFiles&#x60; call.
  , listGeneratedFilesResponseGeneratedFiles :: !(Maybe [GeneratedFile]) -- ^ "generatedFiles" - The list of &#x60;GeneratedFile&#x60;s.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListModelsResponse = ListModelsResponse
  { listModelsResponseModels :: !(Maybe [Model]) -- ^ "models" - The returned Models.
  , listModelsResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token, which can be sent as &#x60;page_token&#x60; to retrieve the next page.  If this field is omitted, there are no more pages.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListOperationsResponse = ListOperationsResponse
  { listOperationsResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - The standard List next-page token.
  , listOperationsResponseOperations :: !(Maybe [Operation]) -- ^ "operations" - A list of operations that matches the specified filter in the request.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListPermissionsResponse = ListPermissionsResponse
  { listPermissionsResponsePermissions :: !(Maybe [Permission]) -- ^ "permissions" - Returned permissions.
  , listPermissionsResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token, which can be sent as &#x60;page_token&#x60; to retrieve the next page.  If this field is omitted, there are no more pages.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ListTunedModelsResponse = ListTunedModelsResponse
  { listTunedModelsResponseNextPageToken :: !(Maybe Text) -- ^ "nextPageToken" - A token, which can be sent as &#x60;page_token&#x60; to retrieve the next page.  If this field is omitted, there are no more pages.
  , listTunedModelsResponseTunedModels :: !(Maybe [TunedModel]) -- ^ "tunedModels" - The returned Models.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data LogprobsResult = LogprobsResult
  { logprobsResultChosenCandidates :: !(Maybe [LogprobsResultCandidate]) -- ^ "chosenCandidates" - Length &#x3D; total number of decoding steps. The chosen candidates may or may not be in top_candidates.
  , logprobsResultTopCandidates :: !(Maybe [TopCandidates]) -- ^ "topCandidates" - Length &#x3D; total number of decoding steps.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data LogprobsResultCandidate = LogprobsResultCandidate
  { logprobsResultCandidateLogProbability :: !(Maybe Float) -- ^ "logProbability" - The candidate&#39;s log probability.
  , logprobsResultCandidateTokenId :: !(Maybe Int) -- ^ "tokenId" - The candidate’s token id value.
  , logprobsResultCandidateToken :: !(Maybe Text) -- ^ "token" - The candidate’s token string value.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Media = Media
  { mediaVideo :: !(Maybe Video) -- ^ "video" - Video as the only one for now.  This is mimicking Vertex proto.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Message = Message
  { messageCitationMetadata :: !(Maybe CitationMetadata) -- ^ /ReadOnly/ "citationMetadata" - Output only. Citation information for model-generated &#x60;content&#x60; in this &#x60;Message&#x60;.  If this &#x60;Message&#x60; was generated as output from the model, this field may be populated with attribution information for any text included in the &#x60;content&#x60;. This field is used only on output.
  , messageAuthor :: !(Maybe Text) -- ^ "author" - Optional. The author of this Message.  This serves as a key for tagging the content of this Message when it is fed to the model as text.  The author can be any alphanumeric string.
  , messageContent :: !(Text) -- ^ /Required/ "content" - Required. The text content of the structured &#x60;Message&#x60;.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkMessage
  :: Text -- ^ 'messageContent': Required. The text content of the structured `Message`.
  -> Message
...
data MessagePrompt = MessagePrompt
  { messagePromptContext :: !(Maybe Text) -- ^ "context" - Optional. Text that should be provided to the model first to ground the response.  If not empty, this &#x60;context&#x60; will be given to the model first before the &#x60;examples&#x60; and &#x60;messages&#x60;. When using a &#x60;context&#x60; be sure to provide it with every request to maintain continuity.  This field can be a description of your prompt to the model to help provide context and guide the responses. Examples: \&quot;Translate the phrase from English to French.\&quot; or \&quot;Given a statement, classify the sentiment as happy, sad or neutral.\&quot;  Anything included in this field will take precedence over message history if the total input size exceeds the model&#39;s &#x60;input_token_limit&#x60; and the input request is truncated.
  , messagePromptMessages :: !([Message]) -- ^ /Required/ "messages" - Required. A snapshot of the recent conversation history sorted chronologically.  Turns alternate between two authors.  If the total input size exceeds the model&#39;s &#x60;input_token_limit&#x60; the input will be truncated: The oldest items will be dropped from &#x60;messages&#x60;.
  , messagePromptExamples :: !(Maybe [Example]) -- ^ "examples" - Optional. Examples of what the model should generate.  This includes both user input and the response that the model should emulate.  These &#x60;examples&#x60; are treated identically to conversation messages except that they take precedence over the history in &#x60;messages&#x60;: If the total input size exceeds the model&#39;s &#x60;input_token_limit&#x60; the input will be truncated. Items will be dropped from &#x60;messages&#x60; before &#x60;examples&#x60;.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkMessagePrompt
  :: [Message] -- ^ 'messagePromptMessages': Required. A snapshot of the recent conversation history sorted chronologically.  Turns alternate between two authors.  If the total input size exceeds the model's `input_token_limit` the input will be truncated: The oldest items will be dropped from `messages`.
  -> MessagePrompt
...
data MetadataFilter = MetadataFilter
  { metadataFilterConditions :: !([Condition]) -- ^ /Required/ "conditions" - Required. The &#x60;Condition&#x60;s for the given key that will trigger this filter. Multiple &#x60;Condition&#x60;s are joined by logical ORs.
  , metadataFilterKey :: !(Text) -- ^ /Required/ "key" - Required. The key of the metadata to filter on.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkMetadataFilter
  :: [Condition] -- ^ 'metadataFilterConditions': Required. The `Condition`s for the given key that will trigger this filter. Multiple `Condition`s are joined by logical ORs.
  -> Text -- ^ 'metadataFilterKey': Required. The key of the metadata to filter on.
  -> MetadataFilter
...
data ModalityTokenCount = ModalityTokenCount
  { modalityTokenCountTokenCount :: !(Maybe Int) -- ^ "tokenCount" - Number of tokens.
  , modalityTokenCountModality :: !(Maybe Modality) -- ^ "modality" - The modality associated with this token count.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Model = Model
  { modelTopK :: !(Maybe Int) -- ^ "topK" - For Top-k sampling.  Top-k sampling considers the set of &#x60;top_k&#x60; most probable tokens. This value specifies default to be used by the backend while making the call to the model. If empty, indicates the model doesn&#39;t use top-k sampling, and &#x60;top_k&#x60; isn&#39;t allowed as a generation parameter.
  , modelName :: !(Text) -- ^ /Required/ "name" - Required. The resource name of the &#x60;Model&#x60;. Refer to [Model variants](https://ai.google.dev/gemini-api/docs/models/gemini#model-variations) for all allowed values.  Format: &#x60;models/{model}&#x60; with a &#x60;{model}&#x60; naming convention of:  * \&quot;{base_model_id}-{version}\&quot;  Examples:  * &#x60;models/gemini-1.5-flash-001&#x60;
  , modelBaseModelId :: !(Text) -- ^ /Required/ "baseModelId" - Required. The name of the base model, pass this to the generation request.  Examples:  * &#x60;gemini-1.5-flash&#x60;
  , modelVersion :: !(Text) -- ^ /Required/ "version" - Required. The version number of the model.  This represents the major version (&#x60;1.0&#x60; or &#x60;1.5&#x60;)
  , modelInputTokenLimit :: !(Maybe Int) -- ^ "inputTokenLimit" - Maximum number of input tokens allowed for this model.
  , modelTopP :: !(Maybe Float) -- ^ "topP" - For [Nucleus sampling](https://ai.google.dev/gemini-api/docs/prompting-strategies#top-p).  Nucleus sampling considers the smallest set of tokens whose probability sum is at least &#x60;top_p&#x60;. This value specifies default to be used by the backend while making the call to the model.
  , modelSupportedGenerationMethods :: !(Maybe [Text]) -- ^ "supportedGenerationMethods" - The model&#39;s supported generation methods.  The corresponding API method names are defined as Pascal case strings, such as &#x60;generateMessage&#x60; and &#x60;generateContent&#x60;.
  , modelTemperature :: !(Maybe Float) -- ^ "temperature" - Controls the randomness of the output.  Values can range over &#x60;[0.0,max_temperature]&#x60;, inclusive. A higher value will produce responses that are more varied, while a value closer to &#x60;0.0&#x60; will typically result in less surprising responses from the model. This value specifies default to be used by the backend while making the call to the model.
  , modelDisplayName :: !(Maybe Text) -- ^ "displayName" - The human-readable name of the model. E.g. \&quot;Gemini 1.5 Flash\&quot;.  The name can be up to 128 characters long and can consist of any UTF-8 characters.
  , modelDescription :: !(Maybe Text) -- ^ "description" - A short description of the model.
  , modelMaxTemperature :: !(Maybe Float) -- ^ "maxTemperature" - The maximum temperature this model can use.
  , modelOutputTokenLimit :: !(Maybe Int) -- ^ "outputTokenLimit" - Maximum number of output tokens available for this model.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkModel
  :: Text -- ^ 'modelName': Required. The resource name of the `Model`. Refer to [Model variants](https://ai.google.dev/gemini-api/docs/models/gemini#model-variations) for all allowed values.  Format: `models/{model}` with a `{model}` naming convention of:  * \"{base_model_id}-{version}\"  Examples:  * `models/gemini-1.5-flash-001`
  -> Text -- ^ 'modelBaseModelId': Required. The name of the base model, pass this to the generation request.  Examples:  * `gemini-1.5-flash`
  -> Text -- ^ 'modelVersion': Required. The version number of the model.  This represents the major version (`1.0` or `1.5`)
  -> Model
...
data MultiSpeakerVoiceConfig = MultiSpeakerVoiceConfig
  { multiSpeakerVoiceConfigSpeakerVoiceConfigs :: !([SpeakerVoiceConfig]) -- ^ /Required/ "speakerVoiceConfigs" - Required. All the enabled speaker voices.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkMultiSpeakerVoiceConfig
  :: [SpeakerVoiceConfig] -- ^ 'multiSpeakerVoiceConfigSpeakerVoiceConfigs': Required. All the enabled speaker voices.
  -> MultiSpeakerVoiceConfig
...
data Part = Part
  { partInlineData :: !(Maybe Blob) -- ^ "inlineData" - Inline media bytes.
  , partFunctionResponse :: !(Maybe FunctionResponse) -- ^ "functionResponse" - The result output of a &#x60;FunctionCall&#x60; that contains a string representing the &#x60;FunctionDeclaration.name&#x60; and a structured JSON object containing any output from the function is used as context to the model.
  , partCodeExecutionResult :: !(Maybe CodeExecutionResult) -- ^ "codeExecutionResult" - Result of executing the &#x60;ExecutableCode&#x60;.
  , partFileData :: !(Maybe FileData) -- ^ "fileData" - URI based data.
  , partExecutableCode :: !(Maybe ExecutableCode) -- ^ "executableCode" - Code generated by the model that is meant to be executed.
  , partVideoMetadata :: !(Maybe VideoMetadata) -- ^ "videoMetadata" - Optional. Video metadata. The metadata should only be specified while the video data is presented in inline_data or file_data.
  , partThought :: !(Maybe Bool) -- ^ "thought" - Optional. Indicates if the part is thought from the model.
  , partText :: !(Maybe Text) -- ^ "text" - Inline text.
  , partThoughtSignature :: !(Maybe ByteArray) -- ^ "thoughtSignature" - Optional. An opaque signature for the thought so it can be reused in subsequent requests.
  , partFunctionCall :: !(Maybe FunctionCall) -- ^ "functionCall" - A predicted &#x60;FunctionCall&#x60; returned from the model that contains a string representing the &#x60;FunctionDeclaration.name&#x60; with the arguments and their values.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Permission = Permission
  { permissionName :: !(Maybe Text) -- ^ /ReadOnly/ "name" - Output only. Identifier. The permission name. A unique name will be generated on create. Examples:     tunedModels/{tuned_model}/permissions/{permission}     corpora/{corpus}/permissions/{permission} Output only.
  , permissionGranteeType :: !(Maybe E'GranteeType) -- ^ "granteeType" - Optional. Immutable. The type of the grantee.
  , permissionRole :: !(E'Role) -- ^ /Required/ "role" - Required. The role granted by this permission.
  , permissionEmailAddress :: !(Maybe Text) -- ^ "emailAddress" - Optional. Immutable. The email address of the user of group which this permission refers. Field is not set when permission&#39;s grantee type is EVERYONE.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkPermission
  :: E'Role -- ^ 'permissionRole': Required. The role granted by this permission.
  -> Permission
...
data PrebuiltVoiceConfig = PrebuiltVoiceConfig
  { prebuiltVoiceConfigVoiceName :: !(Maybe Text) -- ^ "voiceName" - The name of the preset voice to use.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data PredictLongRunningOperation = PredictLongRunningOperation
  { predictLongRunningOperationDone :: !(Maybe Bool) -- ^ "done" - If the value is &#x60;false&#x60;, it means the operation is still in progress. If &#x60;true&#x60;, the operation is completed, and either &#x60;error&#x60; or &#x60;response&#x60; is available.
  , predictLongRunningOperationName :: !(Maybe Text) -- ^ "name" - The server-assigned name, which is only unique within the same service that originally returns it. If you use the default HTTP mapping, the &#x60;name&#x60; should be a resource name ending with &#x60;operations/{unique_id}&#x60;.
  , predictLongRunningOperationError :: !(Maybe Status) -- ^ "error" - The error result of the operation in case of failure or cancellation.
  , predictLongRunningOperationMetadata :: !(Maybe A.Value) -- ^ "metadata" - Metadata for PredictLongRunning long running operations.
  , predictLongRunningOperationResponse :: !(Maybe PredictLongRunningResponse) -- ^ "response"
  } deriving (P.Show, P.Eq, P.Typeable)
...
data PredictLongRunningResponse = PredictLongRunningResponse
  { predictLongRunningResponseGenerateVideoResponse :: !(Maybe GenerateVideoResponse) -- ^ "generateVideoResponse" - The response of the video generation prediction.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data PromptFeedback = PromptFeedback
  { promptFeedbackBlockReason :: !(Maybe E'BlockReason) -- ^ "blockReason" - Optional. If set, the prompt was blocked and no candidates are returned. Rephrase the prompt.
  , promptFeedbackSafetyRatings :: !(Maybe [SafetyRating]) -- ^ "safetyRatings" - Ratings for safety of the prompt. There is at most one rating per category.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data QueryCorpusRequest = QueryCorpusRequest
  ...
  , queryCorpusRequestQuery :: !(Text) -- ^ /Required/ "query" - Required. Query string to perform semantic search.
  , queryCorpusRequestResultsCount :: !(Maybe Int) -- ^ "resultsCount" - Optional. The maximum number of &#x60;Chunk&#x60;s to return. The service may return fewer &#x60;Chunk&#x60;s.  If unspecified, at most 10 &#x60;Chunk&#x60;s will be returned. The maximum specified result count is 100.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkQueryCorpusRequest
  :: Text -- ^ 'queryCorpusRequestQuery': Required. Query string to perform semantic search.
  -> QueryCorpusRequest
...
data QueryCorpusResponse = QueryCorpusResponse
  { queryCorpusResponseRelevantChunks :: !(Maybe [RelevantChunk]) -- ^ "relevantChunks" - The relevant chunks.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data QueryDocumentRequest = QueryDocumentRequest
  { queryDocumentRequestQuery :: !(Text) -- ^ /Required/ "query" - Required. Query string to perform semantic search.
  , queryDocumentRequestResultsCount :: !(Maybe Int) -- ^ "resultsCount" - Optional. The maximum number of &#x60;Chunk&#x60;s to return. The service may return fewer &#x60;Chunk&#x60;s.  If unspecified, at most 10 &#x60;Chunk&#x60;s will be returned. The maximum specified result count is 100.
  , queryDocumentRequestMetadataFilters :: !(Maybe [MetadataFilter]) -- ^ "metadataFilters" - Optional. Filter for &#x60;Chunk&#x60; metadata. Each &#x60;MetadataFilter&#x60; object should correspond to a unique key. Multiple &#x60;MetadataFilter&#x60; objects are joined by logical \&quot;AND\&quot;s.  Note: &#x60;Document&#x60;-level filtering is not supported for this request because a &#x60;Document&#x60; name is already specified.  Example query: (year &gt;&#x3D; 2020 OR year &lt; 2010) AND (genre &#x3D; drama OR genre &#x3D; action)  &#x60;MetadataFilter&#x60; object list:  metadata_filters &#x3D; [  {key &#x3D; \&quot;chunk.custom_metadata.year\&quot;   conditions &#x3D; [{int_value &#x3D; 2020, operation &#x3D; GREATER_EQUAL},                 {int_value &#x3D; 2010, operation &#x3D; LESS}},  {key &#x3D; \&quot;chunk.custom_metadata.genre\&quot;   conditions &#x3D; [{string_value &#x3D; \&quot;drama\&quot;, operation &#x3D; EQUAL},                 {string_value &#x3D; \&quot;action\&quot;, operation &#x3D; EQUAL}}]  Example query for a numeric range of values: (year &gt; 2015 AND year &lt;&#x3D; 2020)  &#x60;MetadataFilter&#x60; object list:  metadata_filters &#x3D; [  {key &#x3D; \&quot;chunk.custom_metadata.year\&quot;   conditions &#x3D; [{int_value &#x3D; 2015, operation &#x3D; GREATER}]},  {key &#x3D; \&quot;chunk.custom_metadata.year\&quot;   conditions &#x3D; [{int_value &#x3D; 2020, operation &#x3D; LESS_EQUAL}]}]  Note: \&quot;AND\&quot;s for the same key are only supported for numeric values. String values only support \&quot;OR\&quot;s for the same key.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkQueryDocumentRequest
  :: Text -- ^ 'queryDocumentRequestQuery': Required. Query string to perform semantic search.
  -> QueryDocumentRequest
...
data QueryDocumentResponse = QueryDocumentResponse
  { queryDocumentResponseRelevantChunks :: !(Maybe [RelevantChunk]) -- ^ "relevantChunks" - The returned relevant chunks.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data RelevantChunk = RelevantChunk
  { relevantChunkChunk :: !(Maybe Chunk) -- ^ "chunk" - &#x60;Chunk&#x60; associated with the query.
  , relevantChunkChunkRelevanceScore :: !(Maybe Float) -- ^ "chunkRelevanceScore" - &#x60;Chunk&#x60; relevance to the query.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data RetrievalMetadata = RetrievalMetadata
  { retrievalMetadataGoogleSearchDynamicRetrievalScore :: !(Maybe Float) -- ^ "googleSearchDynamicRetrievalScore" - Optional. Score indicating how likely information from google search could help answer the prompt. The score is in the range [0, 1], where 0 is the least likely and 1 is the most likely. This score is only populated when google search grounding and dynamic retrieval is enabled. It will be compared to the threshold to determine whether to trigger google search.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data SafetyFeedback = SafetyFeedback
  ...
  , safetyFeedbackRating :: !(Maybe SafetyRating) -- ^ "rating" - Safety rating evaluated from content.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data SafetyRating = SafetyRating
  { safetyRatingCategory :: !(HarmCategory) -- ^ /Required/ "category" - Required. The category for this rating.
  , safetyRatingBlocked :: !(Maybe Bool) -- ^ "blocked" - Was this content blocked because of this rating?
  , safetyRatingProbability :: !(E'Probability) -- ^ /Required/ "probability" - Required. The probability of harm for this content.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkSafetyRating
  :: HarmCategory -- ^ 'safetyRatingCategory': Required. The category for this rating.
  -> E'Probability -- ^ 'safetyRatingProbability': Required. The probability of harm for this content.
  -> SafetyRating
...
data SafetySetting = SafetySetting
  { safetySettingThreshold :: !(E'Threshold) -- ^ /Required/ "threshold" - Required. Controls the probability threshold at which harm is blocked.
  , safetySettingCategory :: !(HarmCategory) -- ^ /Required/ "category" - Required. The category for this setting.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkSafetySetting
  :: E'Threshold -- ^ 'safetySettingThreshold': Required. Controls the probability threshold at which harm is blocked.
  -> HarmCategory -- ^ 'safetySettingCategory': Required. The category for this setting.
  -> SafetySetting
...
data Schema = Schema
  { schemaItems :: !(Maybe Schema) -- ^ "items" - Optional. Schema of the elements of Type.ARRAY.
  , schemaAnyOf :: !(Maybe [Schema]) -- ^ "anyOf" - Optional. The value should be validated against any (one or more) of the subschemas in the list.
  , schemaMinLength :: !(Maybe Text) -- ^ "minLength" - Optional. SCHEMA FIELDS FOR TYPE STRING Minimum length of the Type.STRING
  , schemaMaximum :: !(Maybe Double) -- ^ "maximum" - Optional. Maximum value of the Type.INTEGER and Type.NUMBER
  , schemaPropertyOrdering :: !(Maybe [Text]) -- ^ "propertyOrdering" - Optional. The order of the properties. Not a standard field in open api spec. Used to determine the order of the properties in the response.
  , schemaNullable :: !(Maybe Bool) -- ^ "nullable" - Optional. Indicates if the value may be null.
  ...
  , schemaMaxProperties :: !(Maybe Text) -- ^ "maxProperties" - Optional. Maximum number of the properties for Type.OBJECT.
  , schemaFormat :: !(Maybe Text) -- ^ "format" - Optional. The format of the data. This is used only for primitive datatypes. Supported formats:  for NUMBER type: float, double  for INTEGER type: int32, int64  for STRING type: enum, date-time
  , schemaEnum :: !(Maybe [Text]) -- ^ "enum" - Optional. Possible values of the element of Type.STRING with enum format. For example we can define an Enum Direction as : {type:STRING, format:enum, enum:[\&quot;EAST\&quot;, NORTH\&quot;, \&quot;SOUTH\&quot;, \&quot;WEST\&quot;]}
  , schemaMaxLength :: !(Maybe Text) -- ^ "maxLength" - Optional. Maximum length of the Type.STRING
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkSchema
  :: ModelType -- ^ 'schemaType': Required. Data type.
  -> Schema
mkSchema schemaType =
  Schema
  { schemaItems = Nothing
...
data SearchEntryPoint = SearchEntryPoint
  { searchEntryPointSdkBlob :: !(Maybe ByteArray) -- ^ "sdkBlob" - Optional. Base64 encoded JSON representing array of  tuple.
  , searchEntryPointRenderedContent :: !(Maybe Text) -- ^ "renderedContent" - Optional. Web content snippet that can be embedded in a web page or an app webview.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Segment = Segment
  { segmentPartIndex :: !(Maybe Int) -- ^ /ReadOnly/ "partIndex" - Output only. The index of a Part object within its parent Content object.
  , segmentStartIndex :: !(Maybe Int) -- ^ /ReadOnly/ "startIndex" - Output only. Start index in the given Part, measured in bytes. Offset from the start of the Part, inclusive, starting at zero.
  , segmentText :: !(Maybe Text) -- ^ /ReadOnly/ "text" - Output only. The text corresponding to the segment from the response.
  , segmentEndIndex :: !(Maybe Int) -- ^ /ReadOnly/ "endIndex" - Output only. End index in the given Part, measured in bytes. Offset from the start of the Part, exclusive, starting at zero.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data SemanticRetrieverChunk = SemanticRetrieverChunk
  { semanticRetrieverChunkChunk :: !(Maybe Text) -- ^ /ReadOnly/ "chunk" - Output only. Name of the &#x60;Chunk&#x60; containing the attributed text. Example: &#x60;corpora/123/documents/abc/chunks/xyz&#x60;
  , semanticRetrieverChunkSource :: !(Maybe Text) -- ^ /ReadOnly/ "source" - Output only. Name of the source matching the request&#39;s &#x60;SemanticRetrieverConfig.source&#x60;. Example: &#x60;corpora/123&#x60; or &#x60;corpora/123/documents/abc&#x60;
  } deriving (P.Show, P.Eq, P.Typeable)
...
data SemanticRetrieverConfig = SemanticRetrieverConfig
  { semanticRetrieverConfigSource :: !(Text) -- ^ /Required/ "source" - Required. Name of the resource for retrieval. Example: &#x60;corpora/123&#x60; or &#x60;corpora/123/documents/abc&#x60;.
  , semanticRetrieverConfigQuery :: !(Content) -- ^ /Required/ "query" - Required. Query to use for matching &#x60;Chunk&#x60;s in the given resource by similarity.
  , semanticRetrieverConfigMaxChunksCount :: !(Maybe Int) -- ^ "maxChunksCount" - Optional. Maximum number of relevant &#x60;Chunk&#x60;s to retrieve.
  , semanticRetrieverConfigMetadataFilters :: !(Maybe [MetadataFilter]) -- ^ "metadataFilters" - Optional. Filters for selecting &#x60;Document&#x60;s and/or &#x60;Chunk&#x60;s from the resource.
  , semanticRetrieverConfigMinimumRelevanceScore :: !(Maybe Float) -- ^ "minimumRelevanceScore" - Optional. Minimum relevance score for retrieved relevant &#x60;Chunk&#x60;s.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkSemanticRetrieverConfig
  :: Text -- ^ 'semanticRetrieverConfigSource': Required. Name of the resource for retrieval. Example: `corpora/123` or `corpora/123/documents/abc`.
  -> Content -- ^ 'semanticRetrieverConfigQuery': Required. Query to use for matching `Chunk`s in the given resource by similarity.
  -> SemanticRetrieverConfig
...
data SpeakerVoiceConfig = SpeakerVoiceConfig
  { speakerVoiceConfigVoiceConfig :: !(VoiceConfig) -- ^ /Required/ "voiceConfig" - Required. The configuration for the voice to use.
  , speakerVoiceConfigSpeaker :: !(Text) -- ^ /Required/ "speaker" - Required. The name of the speaker to use. Should be the same as in the prompt.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkSpeakerVoiceConfig
  :: VoiceConfig -- ^ 'speakerVoiceConfigVoiceConfig': Required. The configuration for the voice to use.
  -> Text -- ^ 'speakerVoiceConfigSpeaker': Required. The name of the speaker to use. Should be the same as in the prompt.
  -> SpeakerVoiceConfig
...
data SpeechConfig = SpeechConfig
  { speechConfigVoiceConfig :: !(Maybe VoiceConfig) -- ^ "voiceConfig" - The configuration in case of single-voice output.
  , speechConfigLanguageCode :: !(Maybe Text) -- ^ "languageCode" - Optional. Language code (in BCP 47 format, e.g. \&quot;en-US\&quot;) for speech synthesis.  Valid values are: de-DE, en-AU, en-GB, en-IN, en-US, es-US, fr-FR, hi-IN, pt-BR, ar-XA, es-ES, fr-CA, id-ID, it-IT, ja-JP, tr-TR, vi-VN, bn-IN, gu-IN, kn-IN, ml-IN, mr-IN, ta-IN, te-IN, nl-NL, ko-KR, cmn-CN, pl-PL, ru-RU, and th-TH.
  , speechConfigMultiSpeakerVoiceConfig :: !(Maybe MultiSpeakerVoiceConfig) -- ^ "multiSpeakerVoiceConfig" - Optional. The configuration for the multi-speaker setup. It is mutually exclusive with the voice_config field.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data StringList = StringList
  { stringListValues :: !(Maybe [Text]) -- ^ "values" - The string values of the metadata to store.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data TextCompletion = TextCompletion
  { textCompletionSafetyRatings :: !(Maybe [SafetyRating]) -- ^ "safetyRatings" - Ratings for the safety of a response.  There is at most one rating per category.
  , textCompletionOutput :: !(Maybe Text) -- ^ /ReadOnly/ "output" - Output only. The generated text returned from the model.
  , textCompletionCitationMetadata :: !(Maybe CitationMetadata) -- ^ /ReadOnly/ "citationMetadata" - Output only. Citation information for model-generated &#x60;output&#x60; in this &#x60;TextCompletion&#x60;.  This field may be populated with attribution information for any text included in the &#x60;output&#x60;.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data TextPrompt = TextPrompt
  { textPromptText :: !(Text) -- ^ /Required/ "text" - Required. The prompt text.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkTextPrompt
  :: Text -- ^ 'textPromptText': Required. The prompt text.
  -> TextPrompt
...
data ThinkingConfig = ThinkingConfig
  { thinkingConfigThinkingBudget :: !(Maybe Int) -- ^ "thinkingBudget" - The number of thoughts tokens that the model should generate.
  , thinkingConfigIncludeThoughts :: !(Maybe Bool) -- ^ "includeThoughts" - Indicates whether to include thoughts in the response. If true, thoughts are returned only when available.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Tool = Tool
  { toolFunctionDeclarations :: !(Maybe [FunctionDeclaration]) -- ^ "functionDeclarations" - Optional. A list of &#x60;FunctionDeclarations&#x60; available to the model that can be used for function calling.  The model or system does not execute the function. Instead the defined function may be returned as a FunctionCall with arguments to the client side for execution. The model may decide to call a subset of these functions by populating FunctionCall in the response. The next conversation turn may contain a FunctionResponse with the Content.role \&quot;function\&quot; generation context for the next model turn.
  , toolGoogleSearchRetrieval :: !(Maybe GoogleSearchRetrieval) -- ^ "googleSearchRetrieval" - Optional. Retrieval tool that is powered by Google search.
  , toolGoogleSearch :: !(Maybe GoogleSearch) -- ^ "googleSearch" - Optional. GoogleSearch tool type. Tool to support Google Search in Model. Powered by Google.
  , toolCodeExecution :: !(Maybe A.Value) -- ^ "codeExecution" - Optional. Enables the model to execute code as part of generation.
  , toolUrlContext :: !(Maybe A.Value) -- ^ "urlContext" - Optional. Tool to support URL context retrieval.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data ToolConfig = ToolConfig
  { toolConfigFunctionCallingConfig :: !(Maybe FunctionCallingConfig) -- ^ "functionCallingConfig" - Optional. Function calling config.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data TopCandidates = TopCandidates
  { topCandidatesCandidates :: !(Maybe [LogprobsResultCandidate]) -- ^ "candidates" - Sorted by log probability in descending order.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data TransferOwnershipRequest = TransferOwnershipRequest
  { transferOwnershipRequestEmailAddress :: !(Text) -- ^ /Required/ "emailAddress" - Required. The email address of the user to whom the tuned model is being transferred to.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkTransferOwnershipRequest
  :: Text -- ^ 'transferOwnershipRequestEmailAddress': Required. The email address of the user to whom the tuned model is being transferred to.
  -> TransferOwnershipRequest
...
data TunedModel = TunedModel
  { tunedModelUpdateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "updateTime" - Output only. The timestamp when this model was updated.
  , tunedModelName :: !(Maybe Text) -- ^ /ReadOnly/ "name" - Output only. The tuned model name. A unique name will be generated on create. Example: &#x60;tunedModels/az2mb0bpw6i&#x60; If display_name is set on create, the id portion of the name will be set by concatenating the words of the display_name with hyphens and adding a random portion for uniqueness.  Example:   * display_name &#x3D; &#x60;Sentence Translator&#x60;  * name &#x3D; &#x60;tunedModels/sentence-translator-u3b7m&#x60;
  , tunedModelCreateTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "createTime" - Output only. The timestamp when this model was created.
  , tunedModelTuningTask :: !(TuningTask) -- ^ /Required/ "tuningTask" - Required. The tuning task that creates the tuned model.
  , tunedModelTunedModelSource :: !(Maybe TunedModelSource) -- ^ "tunedModelSource" - Optional. TunedModel to use as the starting point for training the new model.
  , tunedModelBaseModel :: !(Maybe Text) -- ^ "baseModel" - Immutable. The name of the &#x60;Model&#x60; to tune. Example: &#x60;models/gemini-1.5-flash-001&#x60;
  , tunedModelReaderProjectNumbers :: !(Maybe [Text]) -- ^ "readerProjectNumbers" - Optional. List of project numbers that have read access to the tuned model.
  , tunedModelDisplayName :: !(Maybe Text) -- ^ "displayName" - Optional. The name to display for this model in user interfaces. The display name must be up to 40 characters including spaces.
  , tunedModelTemperature :: !(Maybe Float) -- ^ "temperature" - Optional. Controls the randomness of the output.  Values can range over &#x60;[0.0,1.0]&#x60;, inclusive. A value closer to &#x60;1.0&#x60; will produce responses that are more varied, while a value closer to &#x60;0.0&#x60; will typically result in less surprising responses from the model.  This value specifies default to be the one used by the base model while creating the model.
  , tunedModelDescription :: !(Maybe Text) -- ^ "description" - Optional. A short description of this model.
  , tunedModelTopP :: !(Maybe Float) -- ^ "topP" - Optional. For Nucleus sampling.  Nucleus sampling considers the smallest set of tokens whose probability sum is at least &#x60;top_p&#x60;.  This value specifies default to be the one used by the base model while creating the model.
  , tunedModelTopK :: !(Maybe Int) -- ^ "topK" - Optional. For Top-k sampling.  Top-k sampling considers the set of &#x60;top_k&#x60; most probable tokens. This value specifies default to be used by the backend while making the call to the model.  This value specifies default to be the one used by the base model while creating the model.
  , tunedModelState :: !(Maybe E'State3) -- ^ /ReadOnly/ "state" - Output only. The state of the tuned model.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkTunedModel
  :: TuningTask -- ^ 'tunedModelTuningTask': Required. The tuning task that creates the tuned model.
  -> TunedModel
...
data TunedModelSource = TunedModelSource
  { tunedModelSourceTunedModel :: !(Maybe Text) -- ^ "tunedModel" - Immutable. The name of the &#x60;TunedModel&#x60; to use as the starting point for training the new model. Example: &#x60;tunedModels/my-tuned-model&#x60;
  , tunedModelSourceBaseModel :: !(Maybe Text) -- ^ /ReadOnly/ "baseModel" - Output only. The name of the base &#x60;Model&#x60; this &#x60;TunedModel&#x60; was tuned from. Example: &#x60;models/gemini-1.5-flash-001&#x60;
  } deriving (P.Show, P.Eq, P.Typeable)
...
data TuningExample = TuningExample
  { tuningExampleTextInput :: !(Maybe Text) -- ^ "textInput" - Optional. Text model input.
  , tuningExampleOutput :: !(Text) -- ^ /Required/ "output" - Required. The expected model output.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkTuningExample
  :: Text -- ^ 'tuningExampleOutput': Required. The expected model output.
  -> TuningExample
...
data TuningExamples = TuningExamples
  { tuningExamplesExamples :: !(Maybe [TuningExample]) -- ^ "examples" - The examples. Example input can be for text or discuss, but all examples in a set must be of the same type.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data TuningSnapshot = TuningSnapshot
  { tuningSnapshotMeanLoss :: !(Maybe Float) -- ^ /ReadOnly/ "meanLoss" - Output only. The mean loss of the training examples for this step.
  , tuningSnapshotComputeTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "computeTime" - Output only. The timestamp when this metric was computed.
  , tuningSnapshotStep :: !(Maybe Int) -- ^ /ReadOnly/ "step" - Output only. The tuning step.
  , tuningSnapshotEpoch :: !(Maybe Int) -- ^ /ReadOnly/ "epoch" - Output only. The epoch this step was part of.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data TuningTask = TuningTask
  { tuningTaskStartTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "startTime" - Output only. The timestamp when tuning this model started.
  , tuningTaskTrainingData :: !(Dataset) -- ^ /Required/ "trainingData" - Required. Input only. Immutable. The model training data.
  , tuningTaskHyperparameters :: !(Maybe Hyperparameters) -- ^ "hyperparameters" - Immutable. Hyperparameters controlling the tuning process. If not provided, default values will be used.
  , tuningTaskCompleteTime :: !(Maybe DateTime) -- ^ /ReadOnly/ "completeTime" - Output only. The timestamp when tuning this model completed.
  , tuningTaskSnapshots :: !(Maybe [TuningSnapshot]) -- ^ /ReadOnly/ "snapshots" - Output only. Metrics collected during tuning.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkTuningTask
  :: Dataset -- ^ 'tuningTaskTrainingData': Required. Input only. Immutable. The model training data.
  -> TuningTask
...
data UpdateChunkRequest = UpdateChunkRequest
  { updateChunkRequestUpdateMask :: !(Text) -- ^ /Required/ "updateMask" - Required. The list of fields to update. Currently, this only supports updating &#x60;custom_metadata&#x60; and &#x60;data&#x60;.
  , updateChunkRequestChunk :: !(Chunk) -- ^ /Required/ "chunk" - Required. The &#x60;Chunk&#x60; to update.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkUpdateChunkRequest
  :: Text -- ^ 'updateChunkRequestUpdateMask': Required. The list of fields to update. Currently, this only supports updating `custom_metadata` and `data`.
  -> Chunk -- ^ 'updateChunkRequestChunk': Required. The `Chunk` to update.
  -> UpdateChunkRequest
...
data UrlContextMetadata = UrlContextMetadata
  { urlContextMetadataUrlMetadata :: !(Maybe [UrlMetadata]) -- ^ "urlMetadata" - List of url context.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data UrlMetadata = UrlMetadata
  { urlMetadataRetrievedUrl :: !(Maybe Text) -- ^ "retrievedUrl" - Retrieved url by the tool.
  , urlMetadataUrlRetrievalStatus :: !(Maybe E'UrlRetrievalStatus) -- ^ "urlRetrievalStatus" - Status of the url retrieval.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data UsageMetadata = UsageMetadata
  { usageMetadataCandidatesTokensDetails :: !(Maybe [ModalityTokenCount]) -- ^ /ReadOnly/ "candidatesTokensDetails" - Output only. List of modalities that were returned in the response.
  , usageMetadataThoughtsTokenCount :: !(Maybe Int) -- ^ /ReadOnly/ "thoughtsTokenCount" - Output only. Number of tokens of thoughts for thinking models.
  , usageMetadataToolUsePromptTokenCount :: !(Maybe Int) -- ^ /ReadOnly/ "toolUsePromptTokenCount" - Output only. Number of tokens present in tool-use prompt(s).
  , usageMetadataCachedContentTokenCount :: !(Maybe Int) -- ^ "cachedContentTokenCount" - Number of tokens in the cached part of the prompt (the cached content)
  , usageMetadataPromptTokenCount :: !(Maybe Int) -- ^ "promptTokenCount" - Number of tokens in the prompt. When &#x60;cached_content&#x60; is set, this is still the total effective prompt size meaning this includes the number of tokens in the cached content.
  , usageMetadataCandidatesTokenCount :: !(Maybe Int) -- ^ "candidatesTokenCount" - Total number of tokens across all the generated response candidates.
  , usageMetadataPromptTokensDetails :: !(Maybe [ModalityTokenCount]) -- ^ /ReadOnly/ "promptTokensDetails" - Output only. List of modalities that were processed in the request input.
  , usageMetadataTotalTokenCount :: !(Maybe Int) -- ^ "totalTokenCount" - Total token count for the generation request (prompt + response candidates).
  , usageMetadataCacheTokensDetails :: !(Maybe [ModalityTokenCount]) -- ^ /ReadOnly/ "cacheTokensDetails" - Output only. List of modalities of the cached content in the request input.
  , usageMetadataToolUsePromptTokensDetails :: !(Maybe [ModalityTokenCount]) -- ^ /ReadOnly/ "toolUsePromptTokensDetails" - Output only. List of modalities that were processed for tool-use request inputs.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data Video = Video
  { videoVideo :: !(Maybe ByteArray) -- ^ "video" - Raw bytes.
  , videoUri :: !(Maybe Text) -- ^ "uri" - Path to another storage.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data VideoFileMetadata = VideoFileMetadata
  { videoFileMetadataVideoDuration :: !(Maybe Text) -- ^ "videoDuration" - Duration of the video.
  } deriving (P.Show, P.Eq, P.Typeable)
...
data VideoMetadata = VideoMetadata
  { videoMetadataEndOffset :: !(Maybe Text) -- ^ "endOffset" - Optional. The end offset of the video.
  , videoMetadataStartOffset :: !(Maybe Text) -- ^ "startOffset" - Optional. The start offset of the video.
  , videoMetadataFps :: !(Maybe Double) -- ^ "fps" - Optional. The frame rate of the video sent to the model. If not specified, the default value will be 1.0. The fps range is (0.0, 24.0].
  } deriving (P.Show, P.Eq, P.Typeable)
...
data VoiceConfig = VoiceConfig
  { voiceConfigPrebuiltVoiceConfig :: !(Maybe PrebuiltVoiceConfig) -- ^ "prebuiltVoiceConfig" - The configuration for the prebuilt voice to use.
  } deriving (P.Show, P.Eq, P.Typeable)
...
-- Chunk from the web.
data Web = Web
  { webTitle :: !(Maybe Text) -- ^ "title" - Title of the chunk.
  , webUri :: !(Maybe Text) -- ^ "uri" - URI reference of the chunk.
  } deriving (P.Show, P.Eq, P.Typeable)

...
data ClientRequest req contentType res accept = ClientRequest
  { rMethod  :: NH.Method   -- ^ Method of ClientRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of ClientRequest
  , rParams   :: Params -- ^ params of ClientRequest

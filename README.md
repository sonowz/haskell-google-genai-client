## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Generative Language API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Generative Language API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | GenerativeLanguage                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | generative-language                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | GenerativeLanguageConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | GenerativeLanguageRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| GenerativeLanguage.Client    | use the "dispatch" functions to send requests       |
| GenerativeLanguage.Core      | core functions, config and request types            |
| GenerativeLanguage.API       | construct api requests                              |
| GenerativeLanguage.Model     | describes api models                                |
| GenerativeLanguage.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| GenerativeLanguage.ModelLens | lenses for model fields                             |
| GenerativeLanguage.Logging   | logging functions and utils                         |
